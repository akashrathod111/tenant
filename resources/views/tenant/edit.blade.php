                    ...
                    <form method="POST" action="{{ route('tenants.update', $tenant->id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                autofocus autocomplete="name" :value="old('name', $tenant->name)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="text" name="email"
                                autofocus autocomplete="email" :value="old('email', $tenant->email)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="domain_name" class="block mt-1 w-full" type="text" name="domain_name"
                                autofocus autocomplete="domain_name" :value="old('domain_name', $tenant->domains->first()->domain)" />
